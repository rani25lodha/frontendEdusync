...
//       try {
//         const res = await api.get(`/AssessmentTables/${assessmentId}`);
...
//     try {
//       const response = await api.post("/ResultTables", resultDto);
//       console.log("Result submitted successfully:", response.data);
//       alert(
//         `Assessment submitted successfully! Your score: ${score}/${questions.length}`
//       );
//       navigate("/results");
//     } catch (error) {
...
//                 <h5 className="card-title">{`Q${index + 1}: ${q.question}`}</h5>
